...
currently published on the website. It was built in a brand-new SQLite file
...
4. Run `php artisan migrate --force`, `php artisan storage:link`, and the normal
   frontend install/build commands for the project.
5. Create a new local administrator through the secure interactive command:
