...
.igf-legacy-article { width:min(calc(100% - 40px),900px); margin:0 auto; padding:clamp(70px,9vw,120px) 0; color:#424347; font:17px/1.8 'Hanken Grotesk',Arial,sans-serif; }
