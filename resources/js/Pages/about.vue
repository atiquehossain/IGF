...
:deep(.igf-page-blocks--about .igf-page-block--about-pillars .igf-card){position:relative;min-height:360px;overflow:hidden;border:1px solid rgba(71,51,38,.13);background:#fff;box-shadow:0 20px 52px rgba(69,49,34,.09)}
...
:deep(.igf-page-blocks--about .igf-page-block--about-pillars .igf-card p){max-width:510px;margin:0;color:#645d57;font-size:16px;line-height:1.7}
