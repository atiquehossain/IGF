...
final class AdminPermissionRegistry
{
    ...
    private const MENU_DEFINITIONS = [
        ...
        ['id' => 71, 'link' => 'transactional-mail.index', 'name' => 'Email Templates', 'parent_id' => 2],
    ];
    ...
    private const RESOURCE_ACTION_DEFINITIONS = [
        ...
        'transactional-mail' => ['menu' => 'transactional-mail.index', 'label' => 'transactional email templates', 'actions' => ['edit' => 262, 'delete' => 263]],
    ];
    ...
    public static function routeMap(): array
    {
        ...
        return array_replace($map, [
            ...
            'seo.internal-links.index' => ['seo.metadata.view', 'seo.metadata.edit'],
            'seo.media.index' => ['seo.metadata.view', 'seo.metadata.edit'],
            'seo.performance.index' => ['seo.metadata.view', 'seo.metadata.edit'],
            'seo.performance.refresh' => ['seo.metadata.view', 'seo.metadata.edit'],
            ...
            'latest.news.group.store' => 'latest.news.create',
            'latest.news.group.update' => 'latest.news.edit',
            'latest.news.group.status' => 'latest.news.status',
            'latest.news.group.destroy' => 'latest.news.destroy',
            'donationType.group.store' => 'donationType.create',
            'donationType.group.update' => 'donationType.edit',
            'donationType.group.status' => 'donationType.status',
            'donationType.group.destroy' => 'donationType.destroy',
            'donationType.content.edit' => 'donationType.edit',
            'donationType.content.update' => 'donationType.edit',
