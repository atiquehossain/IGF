...
return [
    ...
    // Never allow request inspection or persisted debug payloads in production,
    ...
    'storage' => [
        'enabled'    => strtolower((string) env('APP_ENV', 'production')) !== 'production',
        'open'       => strtolower((string) env('APP_ENV', 'production')) === 'production'
            ? false
            : env('DEBUGBAR_OPEN_STORAGE'), // bool/callback.
...
//                'vendor/laravel/framework/src/Illuminate/Session', // Exclude sessions queries
        ...
        'session' => [
            ...
            'masked' => ['*password*', '*secret*', '*token*', '*authorization*', '*cookie*', 'login_*'],
        ],
        'symfony_request' => [
            ...
            'masked' => ['*password*', '*secret*', '*token*', '*authorization*', '*cookie*', '*api_key*', '*app_key*'],
        ],
        'events' => [
