...
<main class="seo2">
    ...
    @unless($canEditMetadata)<div class="seo2-alert seo2-alert--warning" role="status">@if($canRestoreRevisions)<strong>Revision restore access.</strong> You can inspect previews, checklist results and history, and restore earlier versions. Saving other SEO changes requires SEO edit access.@else<strong>Read-only SEO access.</strong> You can inspect previews, checklist results and history. SEO edit access includes both saving changes and restoring earlier versions.@endif</div>@endunless
