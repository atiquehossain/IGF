    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing:border-box; }
            body.layout-wrapper { min-height:100vh; margin:0; background:var(--igf-surface); color:var(--igf-ink); font-family:'Hanken Grotesk',sans-serif; font-size:16px; -webkit-font-smoothing:antialiased; }
            body.layout-wrapper button, body.layout-wrapper input, body.layout-wrapper select { font-family:inherit; }
            body.layout-wrapper a:focus-visible, body.layout-wrapper button:focus-visible, body.layout-wrapper input:focus-visible, body.layout-wrapper select:focus-visible { outline:3px solid rgba(255,117,0,.35); outline-offset:2px; }
            ...
            .igf-sidebar-close { display:none; align-items:center; justify-content:center; flex:0 0 34px; width:34px; height:34px; margin-left:auto; padding:0; border:0; border-radius:50%; background:transparent; color:var(--igf-muted); cursor:pointer; }
            ...
            aside.left-panel .navbar-nav > li > a { display:flex; align-items:center; gap:13px; min-height:43px; margin:2px 0; padding:10px 14px; border:0; border-right:2px solid transparent; border-radius:0 8px 8px 0; color:var(--igf-muted); font-size:13px; font-weight:700; line-height:1.2; letter-spacing:.02em; text-decoration:none; transition:background .18s,color .18s,border-color .18s; }
            ...
            .igf-nav-group summary,.igf-all-tools summary { display:flex; align-items:center; gap:13px; min-height:41px; padding:9px 14px; border-radius:8px; color:#77777c; font-size:12px; font-weight:800; letter-spacing:.03em; cursor:pointer; list-style:none; }
            ...
            .igf-nav-group > ul > li > a { min-height:37px!important; padding-block:8px!important; font-size:12px!important; }
            .igf-sidebar-footer { flex:0 0 auto; padding:15px 20px 20px; border-top:1px solid var(--igf-line); }
            .igf-sidebar-footer a, .igf-sidebar-footer button { display:flex; align-items:center; gap:12px; width:100%; min-height:36px; padding:8px 10px; border:0; background:transparent; color:var(--igf-muted); font-size:12px; font-weight:700; text-align:left; text-decoration:none; cursor:pointer; }
            ...
            .right-panel { min-height:100vh; margin-left:var(--igf-sidebar)!important; padding-top:var(--igf-topbar)!important; background:var(--igf-surface); transition:margin-left .2s ease; }
            ...
            .right-panel .menutoggle { display:none; float:none!important; width:34px!important; padding:7px; border:0; background:transparent; color:var(--igf-muted); }
            ...
            .igf-admin-search input { width:100%; height:34px; padding:6px 14px 6px 36px; border:1px solid var(--igf-line); border-radius:999px; background:#fff; color:var(--igf-ink); font-size:13px; outline:0; }
            .igf-admin-search input:focus { border-color:var(--igf-orange); box-shadow:0 0 0 3px rgba(255,117,0,.1); }
            .igf-top-links { display:flex; align-items:center; gap:25px; }
            .igf-top-links a { color:var(--igf-muted); font-size:12px; font-weight:700; text-decoration:none; }
            .igf-top-links a:hover { color:var(--igf-primary); }
            .igf-quick-create { display:inline-flex; align-items:center; gap:8px; height:36px; padding:0 18px; border-radius:8px; background:linear-gradient(135deg,#9c4500,#783300); box-shadow:0 4px 12px rgba(120,51,0,.2); color:#fff!important; font-size:12px; font-weight:800; letter-spacing:.02em; text-decoration:none!important; }
            .igf-quick-create:hover { opacity:.9; }
            .igf-language > button, .user-area > button { display:flex; align-items:center; justify-content:center; width:34px; height:34px; padding:0; border:0; border-radius:50%; background:transparent; color:var(--igf-muted); cursor:pointer; }
            ...
            .user-area .user-avatar { width:32px; height:32px; border:1px solid var(--igf-line); object-fit:cover; }
            ...
            .user-menu .nav-link { display:flex; align-items:center; gap:9px; width:100%; padding:9px 10px; color:var(--igf-muted); font-size:13px; }
            ...
            body.open .right-panel { margin-left:83px!important; }
            ...
            body.open .igf-nav-group summary span, body.open .igf-all-tools summary span { display:none; }
            ...
            @media(max-width:1010px) {
                ...
                .right-panel { margin-left:83px!important; }
                ...
                .igf-nav-group summary span, .igf-all-tools summary span { display:none; }
                ...
                aside.left-panel.open-menu .igf-nav-group summary span, aside.left-panel.open-menu .igf-all-tools summary span { display:block; }
                ...
                .igf-top-links { display:none; }
            }
            @media(max-width:760px) {
                aside.left-panel { display:none; width:256px!important; max-width:256px!important; }
                .right-panel, body.open .right-panel { margin-left:0!important; }
                ...
                .igf-nav-group summary span, .igf-all-tools summary span { display:block; }
                ...
                .igf-quick-create { width:36px; padding:0; justify-content:center; }
            ...
            @media(max-width:480px) {
                ...
                .igf-mobile-search summary { display:flex; width:40px; height:40px; align-items:center; justify-content:center; cursor:pointer; border-radius:10px; }
                ...
                .igf-mobile-search button { border:0; border-radius:8px; padding:8px 12px; background:#9c4500; color:#fff; font-weight:700; }
            }
