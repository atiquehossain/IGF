                            ...
                            <div class="card-body">
                                <form class="fileUploadForm" action="{{ route('document.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group has-success">
                                        <label for="notice_type" class="control-label mb-1">
                                            {{ $Lang->DisplayImage }}
                                        </label>
                                        <div class="form-group text-center">
                                            <div class="file-upload">
                                                <label for="image_path" class="file-upload_label">
                                                    <img class="file-upload_img" id="upload_image" src="{{ asset('/') }}image/no-image.png">
                                                </label>
                                        ...
                                        <div class="form-group text-center">
                                            <div class="file-upload">
                                                <label for="file" class="file-upload_label">
                                                    <img class="file-upload_img" id="upload_file" src="{{ asset('/') }}image/no-image.png">
                                                </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group has-success">
                                                ...
                                                <input name="release_at" type="text" value="{{ old('release_at') }}" class="form-control datepicker" readonly required>
                    ...
                    <table class="table" id="banner_table">
                        <thead>
                            <tr>
                                ...
                                <th width="10%"><strong>{{ $Lang->Common->Form->{{ $Lang->Common->Form->Type }} }}</strong></th>
                            ...
                            <tr id="{{ @$document->id }}">
                                <td class="avatar">
                                    <div class="round-img">
                                        ...
                                        ?>
                                        <a href="javascript:void(0)"><img class="rounded" src="{{ $notice_board_path }}" alt=""></a>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <?= App\Link::action(@$document->id, @$document->status) ?>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
{{-- Modal --}}
<div class="modal fade" id="bannerModal" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="mediumModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form class="fileUploadFormEdit" action="{{ route('document.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <strong class="card-title">{{ $Lang->Common->Edit }} {{ $Lang->Document }}s</strong>
                        ...
                        <div class="form-group text-center">
                            <div class="file-upload">
                                <label for="e_image_path" class="file-upload_label">
                                    <img class="file-upload_img" id="e_upload_image" src="{{ asset('/') }}image/no-image.png">
                                </label>
                        ...
                        <div class="form-group text-center">
                            <div class="file-upload">
                                <label for="e_file" class="file-upload_label">
                                    <img class="file-upload_img" id="e_upload_file" src="{{ asset('/') }}image/no-image.png">
                                </label>
