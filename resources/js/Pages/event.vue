...
<template>
  <Layout>
    <div v-if="event" class="igf-event">
      ...
      <figure v-if="event.image_url" class="igf-event__image"><img :src="event.image_url" :alt="event.image_alt || event.title"></figure>
      <section v-if="event.content_kind === 'event'" class="igf-event__schedule">
        <div class="igf-shell"><EventFacts :event="event" :settings="archiveSettings" :regional="regional" /></div>
      </section>
