        ...
        return [
            ...
            'volunteer_applications' => [
                ...
                'apply' => fn (Builder $query) => $this->anonymize($query, fn (Volunteer $record) => [
                    ...
                    'occupation' => null, 'occupation_other' => null,
                    'education_level' => null, 'blood_group' => null,
                    'emergency_response_training' => null,
                    'skill' => null, 'skill_other' => null,
                    'consent_version' => null, 'consent_locale' => null,
                    'consent_text_hash' => null, 'consent_text_snapshot' => null,
                    'consented_at' => null,
                    'internal_notes' => null,
                    'follow_up_at' => null, 'anonymized_at' => now(),
                ]),
