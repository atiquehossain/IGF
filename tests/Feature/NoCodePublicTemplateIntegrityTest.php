...
class NoCodePublicTemplateIntegrityTest extends TestCase
{
    ...
    public function test_public_vue_templates_render_customizer_values_instead_of_fixed_headings(): void
    {
        $bindings = [
            ...
            'sponsor_child.vue' => ['settings.hero_cta_label', 'settings.children_field_label', 'settings.sending_label', 'settings.selection_title', 'settings.selection_body', 'settings.value.selection_impact', 'settings.selection_note', 'settings.details_step_label', 'settings.success_title', 'settings.success_body', 'settings.success_next_body', 'settings.success_restart_label'],
            ...
            'events.vue' => ['settings.events_eyebrow', 'settings.value.events_empty_title', 'presentation.value.empty_title', '{{ emptyTitle }}'],
