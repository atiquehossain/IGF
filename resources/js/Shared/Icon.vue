...
<template>
  <svg v-if="name === 'en'" enable-background="new 0 0 512 512" version="1.1" viewBox="0 0 512 512" xml:space="preserve"
  ...
  <svg v-else-if="name === 'ar'" id="Capa_1" version="1.1" xmlns="http://www.w3.org/2000/svg"
