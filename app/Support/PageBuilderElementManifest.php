        ...
        'team' => [
            ...
            'fields' => [
                ...
                'profile_behavior' => [
                    ...
                    'default' => 'panel',
                    'options' => [
                        'panel' => 'Show in the directory',
                        'modal' => 'Open in a dialog',
                        'link' => 'Open the profile link',
                    ],
                ],
                'animation_enabled' => [
                    'label' => 'Use gentle profile transitions',
                    'kind' => 'boolean',
                    'translatable' => false,
                    'required' => true,
                    'default' => true,
                ...
                'autoplay' => [
                    'label' => 'Rotate featured profiles automatically',
                    'kind' => 'boolean',
                    'translatable' => false,
                    'required' => true,
                    'default' => true,
