                        ...
                        <form action="{{ route('gallery.update') }}" method="post" enctype="multipart/form-data">
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <?php
                                  ...
                                  $isValidUrl = filter_var($gallery->path, FILTER_VALIDATE_URL);
                                if (empty($isValidUrl)) {
                                    $gallery->path = route('gallery.image', [$gallery->id, '430X360', $gallery->path]);
                                }
                                ?>
                                    <div class="tab-pane fade {{ $isActive }}" id="{{$translation->id}}" role="tabpanel" aria-labelledby="{{$translation->id}}-tab">
                                        ...
                                        <div class="form-group has-success">
                                                ...
                                                <input name="name[{{$lang}}]" type="text" value="{{old('name.'. $lang, @$gallery->name)}}"
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <textarea class="form-control form-control-danger" name="description[{{$lang}}]" rows="4" maxlength="120" data-e2e="gallery-description-{{ $lang }}">{{old('description.'. $lang, @$gallery->description)}}</textarea>
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <div class="file-upload">
                                                <label for="gallery_image_{{$lang}}" class="file-upload_label">
                                                    <img class="file-upload_img" id="upload_img_{{$lang}}" src="{{ $gallery->path}}">
                                                </label>
                    ...
                    ?>
                        <div class="tab-pane fade {{ $isActive }}" id="{{$translation->id}}-albam" role="tabpanel" aria-labelledby="{{$translation->id}}-tab">
                            ...
                            <div class="form-group has-success">
                                ...
                                <input name="name[{{$lang}}]" type="text" value="{{old('name.'. $lang, @$translation->name)}}" class="form-control" required>
                                @if ($errors->has('name.'. $lang))
