...
<style>
    ...
    .dash-quick{margin-bottom:24px}.dash-quick-head{display:flex;align-items:end;justify-content:space-between;gap:18px;margin-bottom:12px}.dash-quick-head h2{margin:0;font:600 20px/1.3 'Literata',serif}.dash-quick-head p{margin:0;color:#5e5d66;font-size:12px}.dash-quick-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.dash-quick-link{display:grid;grid-template-columns:39px minmax(0,1fr);gap:12px;align-items:start;padding:16px;border:1px solid var(--dash-line);border-radius:11px;background:#fff;color:#191c1d;text-decoration:none!important;transition:border-color .18s,transform .18s,box-shadow .18s}.dash-quick-link:hover{border-color:#ffb47a;color:#9c4500;transform:translateY(-2px);box-shadow:0 9px 22px rgba(36,36,43,.06)}.dash-quick-link>i{display:grid;width:39px;height:39px;place-content:center;border-radius:9px;background:#fff1e6;color:#ff7500}.dash-quick-link strong,.dash-quick-link small{display:block}.dash-quick-link strong{margin-bottom:4px;font-size:12px}.dash-quick-link small{color:#68666b;font-size:10px;line-height:1.45}
    .dash-health{display:grid;gap:8px;margin:0 0 22px}.dash-health-item{display:flex;align-items:center;justify-content:space-between;gap:18px;padding:13px 16px;border:1px solid #f0c9a9;border-left:4px solid #ff7500;border-radius:8px;background:#fff8f2}.dash-health-item strong,.dash-health-item small{display:block}.dash-health-item strong{margin-bottom:3px;font-size:12px}.dash-health-item small{color:#68666b;font-size:11px}.dash-health-item a{flex:0 0 auto;color:#9c4500;font-size:11px;font-weight:850;text-decoration:none}
    ...
    @media(max-width:640px){.igf-dashboard{padding:24px 15px 42px}.dash-heading{margin-bottom:21px}.dash-heading p{font-size:14px}.dash-quick-head{align-items:start;flex-direction:column;gap:4px}.dash-quick-grid{grid-template-columns:1fr}.dash-metrics{grid-template-columns:1fr;gap:14px}.dash-metric{min-height:137px;padding:19px}.dash-body{gap:14px}.dash-side{display:flex}.dash-chart{min-height:390px;padding:19px 15px}.dash-chart-plot{min-height:270px;margin-left:31px}.dash-bars{gap:5px}.dash-localization,.dash-activity{padding:19px}}
</style>
    ...
    @if($quickActions->isNotEmpty())
        <section class="dash-quick" aria-labelledby="quick-actions-title">
            <div class="dash-quick-head">
                ...
                <p>{{ number_format($metrics['new_enquiries']) }} new public {{ $metrics['new_enquiries'] === 1 ? 'enquiry' : 'enquiries' }} waiting for review</p>
            </div>
