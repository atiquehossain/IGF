                            ...
                            <div class="card-body">
                                <form action="{{route('upazila.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <select name="district_id" type="text" class="form-control">
                    ...
                    <table class="table" id="upazila_table">
                        ...
                        <tbody>
                            ...
                            <tr id="{{ @$upazila->id }}">
                                ...
                                <td>
                                    <?=App\Link::action(@$upazila->id, @$upazila->status) ?>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
{{-- Modal --}}
@if($canEdit)
<div class="modal fade" id="upazilaModal" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="mediumModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <form action="{{route('upazila.update')}}" method="POST" enctype="multipart/form-data">
                <div class="modal-header">
                    <strong class="card-title">{{ $Lang->Common->Edit }} {{ $Lang->UpazilaTitle }}</strong>
