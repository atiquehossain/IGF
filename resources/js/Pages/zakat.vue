...
.igf-zakat-impact__details:hover{color:color-mix(in srgb,var(--brown) 82%,#000)}
.igf-zakat-impact__details:focus-visible{outline:3px solid color-mix(in srgb,var(--orange) 35%,transparent);outline-offset:4px;border-radius:3px}
