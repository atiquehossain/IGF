        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-md-6">
                <a class="btn btn-sm btn-secondary float-right" href="{{ route('annual.report.index') }}" id="go-back">
          ...
          <div class="modal-body">
            <form class="form-horizontal" action="{{ route('annual.report.update') }}" method="post"
              ...
              @php
                $isValidUrl = filter_var(@$annual_report->image_path, FILTER_VALIDATE_URL);
                if (empty($isValidUrl) && $annual_report) {
                    $annual_report->annual_report_path = route('annual.report.image', $annual_report->image_path);
                }
              @endphp

              <input name="id" type="hidden" class="form-control" value="{{ @$annual_report->id }}">
              <div class="row">
                <div class="col-8">
                  <div class="form-group has-success">
                    <label for="title" class="control-label mb-1">{{ $Lang->Common->Form->Title }}</label>
                    <input name="title" type="text" value="{{ $annual_report->title }}" class="form-control"
                      data-e2e="title">
                    @if ($errors->has('title'))
                ...
                <div class="col-3">
                  <div class="form-group has-success">
                    ...
                    <input name="published_at" type="text"
                      value="{{ date('d-m-Y', strtotime(@$annual_report->published_at)) }}"
                ...
                {{-- <div class="col-3">
                  <div class="form-group has-success">
                    ...
                    <input name="location" type="text" value="{{ @$annual_report->location }}" class="form-control">
                  ...
                  <div class="form-group text-center">
                    ...
                    <div class="file-upload">
                      <label for="annual_report_path" class="file-upload_label">
                        <img class="file-upload_pdf" id="upload_pdf"
                          src="{{ $annual_report->annual_report_path ? asset('/image/pdf.png') : asset('/image/no-image.png') }}">
                      </label>
                      <input type="file" onchange="changefile(event, `upload_pdf`)" name="annual_report_path"
                        value="{{ old('annual_report_path') }}" id="annual_report_path" class="file-upload_input"
                        data-e2e="annual_report_path">
                    </div>
