...
<style>
    ...
    .simple-team-directory-settings{margin:0 0 18px;padding:14px;border:1px solid #e2c5ab;border-radius:10px;background:#fff8f1}.simple-team-directory-settings legend{padding:0 6px;color:var(--brown);font-size:12px;font-weight:850}.simple-team-directory-settings>p{margin:0 0 13px;color:var(--muted);font-size:11px;line-height:1.5}.simple-team-directory-settings .simple-check{margin-bottom:13px}
    .simple-preview-team-directory{display:grid;grid-template-columns:minmax(170px,.72fr) minmax(220px,1fr) minmax(220px,.9fr);gap:16px;align-items:stretch}.simple-preview-team-directory.is-map-right .simple-preview-team-directory__map{order:3}.simple-preview-team-directory.is-map-right .simple-preview-team-directory__profile{order:1}.simple-preview-team-directory__map,.simple-preview-team-directory__people,.simple-preview-team-directory__profile{min-width:0;padding:16px;border:1px solid var(--line);border-radius:15px;background:#fff}.simple-preview-team-directory__map{background:linear-gradient(160deg,#302c29,#47352a);color:#fff}.simple-preview-team-directory__map h3,.simple-preview-team-directory__people h3,.simple-preview-team-directory__profile h3{margin:0 0 5px;font:700 18px/1.2 'Literata',serif}.simple-preview-team-directory__map h3{color:#fff}.simple-preview-team-directory__map p{margin:0;color:#e8ddd4;font-size:10px}.simple-preview-team-directory__map svg{display:block;width:min(150px,82%);height:auto;margin:14px auto 10px}.simple-preview-team-directory__map path{fill:#ff8c2b;stroke:#fff;stroke-width:2}.simple-preview-team-directory__filters{display:flex;flex-wrap:wrap;gap:5px;margin-top:10px}.simple-preview-team-directory__filters span{padding:4px 7px;border:1px solid rgba(255,255,255,.32);border-radius:99px;font-size:8px}.simple-preview-team-directory__people ul{display:grid;gap:7px;margin:10px 0 0;padding:0;list-style:none}.simple-preview-team-directory__person{display:grid;grid-template-columns:38px minmax(0,1fr);align-items:center;gap:9px;padding:7px;border:1px solid var(--line);border-radius:9px;background:#faf8f6}.simple-preview-team-directory__person:first-child{border-color:var(--orange);box-shadow:0 0 0 2px rgba(255,117,0,.12)}.simple-preview-team-directory__avatar{display:grid;width:38px;height:38px;place-items:center;overflow:hidden;border-radius:50%;background:#f6dfcc;color:var(--brown);font-size:10px;font-weight:900}.simple-preview-team-directory__avatar img{width:100%;height:100%;object-fit:cover}.simple-preview-team-directory__person strong,.simple-preview-team-directory__person small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.simple-preview-team-directory__person strong{font-size:10px}.simple-preview-team-directory__person small{margin-top:2px;color:var(--muted);font-size:8px}.simple-preview-team-directory__profile{display:flex;flex-direction:column;justify-content:center;background:#f7f1eb}.simple-preview-team-directory__profile>small{width:fit-content;margin-bottom:9px;padding:4px 7px;border-radius:99px;background:#ffe3cc;color:var(--brown);font-size:8px;font-weight:900;text-transform:uppercase}.simple-preview-team-directory__profile p{margin:4px 0 0;color:var(--muted);font-size:10px;line-height:1.45}.simple-preview-team-directory__profile .simple-preview-team-directory__behavior{margin-top:12px;color:var(--brown);font-weight:850}.simple-preview-team-directory.is-profile-modal .simple-preview-team-directory__profile{border:2px solid var(--orange);box-shadow:0 16px 36px rgba(47,32,21,.2)}.simple-preview-team-directory.is-profile-link .simple-preview-team-directory__profile{border-style:dashed;background:#fff}.simple-preview-team-directory--no-map{grid-template-columns:minmax(220px,1fr) minmax(220px,.9fr)}
    @container (max-width:820px){.simple-preview-team-directory,.simple-preview-team-directory--no-map{grid-template-columns:1fr 1fr}.simple-preview-team-directory__profile{grid-column:1/-1}.simple-preview-team-directory.is-map-right .simple-preview-team-directory__map{order:initial}.simple-preview-team-directory.is-map-right .simple-preview-team-directory__profile{order:initial}}@container (max-width:500px){.simple-preview-team-directory,.simple-preview-team-directory--no-map{grid-template-columns:1fr}.simple-preview-team-directory__profile{grid-column:auto}}
    .simple-team-showcase-settings .simple-check{margin-bottom:13px}.simple-preview-team-heroes{display:grid;grid-template-columns:minmax(240px,.9fr) minmax(270px,1.1fr);gap:clamp(18px,3cqw,38px);align-items:stretch}.simple-preview-team-heroes.is-map-right .simple-preview-team-heroes__story{order:1}.simple-preview-team-heroes.is-map-right .simple-preview-team-heroes__map{order:2}.simple-preview-team-heroes--no-map{grid-template-columns:minmax(0,720px)}.simple-preview-team-heroes__map,.simple-preview-team-heroes__story{min-width:0;overflow:hidden;border-radius:22px}.simple-preview-team-heroes__map{display:flex;min-height:430px;flex-direction:column;padding:22px;background:linear-gradient(155deg,#173c35,#005547);color:#fff}.simple-preview-team-heroes__map h3{margin:0;font:700 clamp(22px,3cqw,32px)/1.15 'Literata',serif;color:#fff}.simple-preview-team-heroes__map p{margin:6px 0 0;color:#e4f0ed;font-size:11px;line-height:1.45}.simple-preview-team-heroes__map svg{display:block;width:100%;max-width:330px;max-height:365px;margin:auto;overflow:visible}.simple-preview-team-heroes__map path{fill:#005547;stroke:#ffcb07;stroke-width:2.8;vector-effect:non-scaling-stroke;transition:fill .2s ease}.simple-preview-team-heroes__map g:first-of-type path{fill:#087162}.simple-preview-team-heroes__map text{fill:#fff;font-size:11px;font-weight:850;text-anchor:middle;paint-order:stroke;stroke:#005547;stroke-width:3px;stroke-linejoin:round}.simple-preview-team-heroes__story{display:flex;min-height:430px;flex-direction:column;justify-content:center;padding:clamp(24px,4cqw,44px);border:1px solid #eadfd5;background:#fff8f1;box-shadow:0 18px 42px rgba(40,31,24,.1)}.simple-preview-team-heroes__story.is-animated{animation:simple-team-heroes-in .45s ease both}.simple-preview-team-heroes__eyebrow{margin:0 0 8px!important;color:var(--orange)!important;font-size:10px!important;font-weight:900;letter-spacing:.12em;text-transform:uppercase}.simple-preview-team-heroes__story h3{margin:0 0 5px;font:700 clamp(25px,4cqw,40px)/1.13 'Literata',serif}.simple-preview-team-heroes__role{margin:0!important;color:var(--brown)!important;font-size:12px!important;font-weight:850}.simple-preview-team-heroes__bio{display:-webkit-box;overflow:hidden;margin:14px 0 0!important;color:var(--muted)!important;font-size:12px!important;line-height:1.65!important;-webkit-box-orient:vertical;-webkit-line-clamp:5}.simple-preview-team-heroes__qualification{margin:10px 0 0!important;color:#554b44!important;font-size:10px!important}.simple-preview-team-heroes__profiles{display:flex;gap:10px;margin:22px 0 0;padding:0;list-style:none}.simple-preview-team-heroes__profile{display:grid;width:66px;min-width:66px;justify-items:center;gap:5px}.simple-preview-team-heroes__avatar{display:grid;width:60px;height:60px;place-items:center;overflow:hidden;border:3px solid #fff;border-radius:50%;background:#f2d7c0;color:var(--brown);font-size:13px;font-weight:900;box-shadow:0 0 0 1px #d7c6b8}.simple-preview-team-heroes__avatar img{width:100%;height:100%;object-fit:cover}.simple-preview-team-heroes__profile.is-selected .simple-preview-team-heroes__avatar{border-color:#ffcb07;box-shadow:0 0 0 3px rgba(255,117,0,.24)}.simple-preview-team-heroes__profile small{display:block;width:100%;overflow:hidden;color:var(--muted);font-size:8px;font-weight:800;text-align:center;text-overflow:ellipsis;white-space:nowrap}.simple-preview-team-heroes__links{display:flex;align-items:center;gap:7px;margin:18px 0 0!important;color:var(--brown)!important;font-size:10px!important;font-weight:850}.simple-preview-team-heroes__status{width:fit-content;margin:13px 0 0!important;padding:5px 8px;border-radius:99px;background:#fff;color:#65564a!important;font-size:8px!important;font-weight:800}@keyframes simple-team-heroes-in{from{opacity:0;transform:translateY(9px)}to{opacity:1;transform:none}}@container (max-width:720px){.simple-preview-team-heroes,.simple-preview-team-heroes--no-map{grid-template-columns:1fr}.simple-preview-team-heroes.is-map-right .simple-preview-team-heroes__map,.simple-preview-team-heroes.is-map-right .simple-preview-team-heroes__story{order:initial}.simple-preview-team-heroes__map{min-height:360px}.simple-preview-team-heroes__map svg{max-height:290px}.simple-preview-team-heroes__story{min-height:0}}@media (prefers-reduced-motion:reduce){.simple-preview-team-heroes__story.is-animated{animation:none}.simple-preview-team-heroes__map path{transition:none}}
    .simple-preview-block--team-heroes{background:#f5efe8}.simple-preview-team-heroes{grid-template-areas:'map content';grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;align-items:start;background:transparent}.simple-preview-team-heroes.is-map-right{grid-template-areas:'content map'}.simple-preview-team-heroes--no-map{grid-template-areas:'content';grid-template-columns:minmax(0,1fr)}.simple-preview-team-heroes__content{grid-area:content;min-width:0}.simple-preview-team-heroes__heading{max-width:620px;margin-bottom:26px}.simple-preview-team-heroes__eyebrow{display:flex;align-items:center;gap:7px;margin:0 0 7px!important;color:#9b4308!important;font-size:10px!important;font-weight:850;letter-spacing:.08em;text-transform:uppercase}.simple-preview-team-heroes__eyebrow::before{content:'○ ○';color:var(--orange);font-size:10px;letter-spacing:1px}.simple-preview-team-heroes__heading h2{margin:0;color:var(--ink);font:700 clamp(30px,4cqw,44px)/1 'Literata',serif;letter-spacing:-.035em}.simple-preview-team-heroes__lead{max-width:590px;margin:14px 0 0!important;color:#574c45!important;font-size:12px!important;line-height:1.6!important}.simple-preview-team-heroes__profiles{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin:0;padding:0;list-style:none}.simple-preview-team-heroes__person{display:flex;min-width:0;min-height:205px;align-items:center;flex-direction:column;gap:6px;padding:16px 5px;border-radius:8px;background:transparent;text-align:center}.simple-preview-team-heroes__person.is-selected{background:#fff0df;box-shadow:0 5px 15px rgba(95,46,14,.16)}.simple-preview-team-heroes__avatar{width:min(116px,calc(100% - 8px));height:auto;aspect-ratio:1;border:0;box-shadow:none;font-size:27px}.simple-preview-team-heroes__person strong{margin-top:3px;color:var(--ink);font-size:12px;line-height:1.35}.simple-preview-team-heroes__person small{color:#6a5a50;font-size:9px;line-height:1.4}.simple-preview-team-heroes__profile{display:block;width:auto;min-width:0;min-height:230px;margin-top:25px;padding:0;border:0;border-radius:0;background:transparent;box-shadow:none}.simple-preview-team-heroes__profile.is-animated{animation:simple-team-heroes-in .3s ease both}.simple-preview-team-heroes__profile-heading{display:flex;align-items:flex-start;flex-direction:column}.simple-preview-team-heroes__profile-heading h3{margin:3px 0 0;color:var(--ink);font:700 21px/1.3 'Poppins','Hanken Grotesk',Arial,sans-serif;letter-spacing:-.02em}.simple-preview-team-heroes__role{order:-1;margin:0!important;color:#6b625d!important;font-size:12px!important;font-weight:400}.simple-preview-team-heroes__socials{display:flex;gap:6px;margin-top:7px}.simple-preview-team-heroes__socials i{display:grid;width:28px;height:28px;place-items:center;border-radius:50%;background:#27211d;color:#fff;font-size:11px}.simple-preview-team-heroes__biography{margin-top:18px;color:#3f3732;font-size:12px;line-height:1.55}.simple-preview-team-heroes__biography p{margin:0}.simple-preview-team-heroes__biography p+p{margin-top:12px}.simple-preview-team-heroes__qualification{margin:13px 0 0!important;color:#5c5048!important;font-size:11px!important;line-height:1.5!important}.simple-preview-team-heroes__map{grid-area:map;display:block;min-width:0;min-height:0;align-self:start;overflow:visible;padding:0;border:0;border-radius:0;background:transparent;box-shadow:none;color:var(--ink)}.simple-preview-team-heroes__map-stage{width:min(100%,500px);margin:0 auto}.simple-preview-team-heroes__map svg{display:block;width:100%;max-width:none;max-height:none;margin:0;overflow:visible}.simple-preview-team-heroes__map path,.simple-preview-team-heroes__map g:first-of-type path{fill:#5e2a0a;stroke:var(--orange);stroke-width:2;stroke-linejoin:round;vector-effect:non-scaling-stroke}.simple-preview-team-heroes__empty{margin:0;padding:24px;border:1px dashed #d7b99f;border-radius:16px;background:#fff8f2;color:#65584f;font-size:11px;text-align:center}@container (min-width:1050px){.simple-preview-team-heroes__profiles{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (max-width:820px){.simple-preview-team-heroes,.simple-preview-team-heroes.is-map-right{grid-template-areas:'content' 'map';grid-template-columns:1fr}.simple-preview-team-heroes:not(.is-map-right){grid-template-areas:'map' 'content'}.simple-preview-team-heroes__map-stage{width:min(100%,360px)}}@media (prefers-reduced-motion:reduce){.simple-preview-team-heroes__profile.is-animated{animation:none}}
    .simple-preview-team-heroes__eyebrow::before{content:none}.simple-preview-team-heroes__eyebrow-marks{display:inline-flex;gap:4px}.simple-preview-team-heroes__eyebrow-marks span{width:7px;height:7px;border:1.5px solid var(--orange);border-radius:50%}.simple-preview-team-heroes__heading h2{font-family:'Poppins','Hanken Grotesk',Arial,sans-serif;font-weight:500}.simple-preview-team-heroes__heading h2 strong{font-weight:850}
    @keyframes simple-team-heroes-in{from{opacity:0;transform:translateX(10px)}to{opacity:1;transform:none}}
...
(() => {
    ...
    function teamPresentationField(block) {
        ...
        const presentationField = selectField('team_presentation','Team presentation',presentation,teamPresentationChoices)
            .replace('<select ','<select data-auto-rerender ');
        ...
        if (presentation === 'heroes_showcase') {
            content.profile_behavior = 'panel';
            return `${presentationField}<fieldset class="simple-team-directory-settings simple-team-showcase-settings" aria-describedby="simple-team-showcase-help"><legend>Showcase behavior</legend><p id="simple-team-showcase-help">Feature one person beside the Bangladesh map, with circular portraits for choosing another profile. Profile details always stay on this page.</p><input type="hidden" data-content-key="profile_behavior" value="panel"><label class="simple-check"><input data-content-key="show_map" type="checkbox" ${content.show_map !== false?'checked':''}> Show the Bangladesh map</label>${selectField('map_position','Map position',mapPosition,teamMapPositionChoices).replace('<select ','<select data-auto-rerender ')}<label class="simple-check"><input data-content-key="animation_enabled" type="checkbox" ${content.animation_enabled !== false?'checked':''}> Use gentle profile transitions</label><label class="simple-check"><input data-content-key="autoplay" type="checkbox" ${[true,1,'1','true'].includes(content.autoplay)?'checked':''}> Rotate featured profiles automatically</label><p class="simple-section-presentation-help">Visitors can still choose any portrait with touch or a keyboard. Reduced-motion preferences are respected on the public page.</p></fieldset>`;
        }
        if (presentation !== 'directory_map') return `${presentationField}<p class="simple-section-presentation-help">Choose how published profiles appear in this Team section.</p>`;
        ...
        return `${presentationField}<fieldset class="simple-team-directory-settings" aria-describedby="simple-team-directory-help"><legend>Directory behavior</legend><p id="simple-team-directory-help">Visitors can filter published people by Bangladesh division. The preview below mirrors the map placement and profile interaction.</p><label class="simple-check"><input data-content-key="show_map" type="checkbox" ${content.show_map !== false?'checked':''}> Show the Bangladesh map</label>${selectField('map_position','Map position',mapPosition,teamMapPositionChoices).replace('<select ','<select data-auto-rerender ')}${selectField('profile_behavior','When a visitor chooses a person',profileBehavior,teamProfileBehaviorChoices).replace('<select ','<select data-auto-rerender ')}</fieldset>`;
    }
    ...
    function wireInspector(block) {
        ...
        if (canEditBlockContent(block)) {
            ...
            inspector.querySelectorAll('[data-auto-rerender]').forEach(input => input.addEventListener('change', () => { block.content[input.dataset.contentKey] = input.value; if (input.dataset.contentKey === 'content_source') block.content.selected_items = []; if (input.dataset.contentKey === 'team_presentation' && input.value === 'heroes_showcase') block.content.profile_behavior = 'panel'; markDirty('block'); renderInspector(); renderPreview(); }));
    ...
    function renderTeamDirectoryPreview(block, items) {
        ...
        const mapHeadingId = `simple-team-directory-map-${block.uuid}`;
        const peopleHeadingId = `simple-team-directory-people-${block.uuid}`;
        const profileHeadingId = `simple-team-directory-profile-${block.uuid}`;
        ...
        const people = items.slice(0,4).map(item=>{const name=previewItemName(item)||'Team member';const image=previewItemImage(item);const initials=name.split(/\s+/).filter(Boolean).slice(0,2).map(part=>part[0]||'').join('').toUpperCase();const division=teamPreviewDivisionName(item);return `<li class="simple-preview-team-directory__person"><span class="simple-preview-team-directory__avatar">${image?`<img src="${escapeHtml(image)}" alt="">`:`<span aria-hidden="true">${escapeHtml(initials||'IGF')}</span>`}</span><span><strong>${escapeHtml(name)}</strong><small>${escapeHtml([item.designation||item.position||item.title,division].filter(Boolean).join(' · '))}</small></span></li>`}).join('');
        ...
        const profile = featured ? `<article class="simple-preview-team-directory__profile" role="region" aria-labelledby="${escapeHtml(profileHeadingId)}"><small>${profileBehavior === 'modal' ? 'Dialog preview' : profileBehavior === 'link' ? 'Profile link preview' : 'Selected profile'}</small><h3 id="${escapeHtml(profileHeadingId)}">${escapeHtml(previewItemName(featured)||'Team member')}</h3>${featured.designation||featured.position||featured.title?`<p>${escapeHtml(featured.designation||featured.position||featured.title)}</p>`:''}${teamPreviewDivisionName(featured)?`<p>${previewIcon('map','fa-map-marker')} ${escapeHtml(teamPreviewDivisionName(featured))}</p>`:''}<p class="simple-preview-team-directory__behavior">${escapeHtml(behaviorCopy)}</p></article>` : '';
        return `<div class="simple-preview-team-directory is-map-${mapPosition} is-profile-${profileBehavior}${showMap?'':' simple-preview-team-directory--no-map'}" role="region" aria-label="Interactive directory and Bangladesh map preview"><aside class="simple-preview-team-directory__map" aria-labelledby="${escapeHtml(mapHeadingId)}"><h3 id="${escapeHtml(mapHeadingId)}">Bangladesh divisions</h3><p>${showMap?'Map and text filters work together for visitors.':'The map is hidden; division filters remain available.'}</p>${map}<div class="simple-preview-team-directory__filters" role="group" aria-label="Division filter preview">${filterLabels.map(label=>`<span>${escapeHtml(label)}</span>`).join('')}</div></aside><section class="simple-preview-team-directory__people" aria-labelledby="${escapeHtml(peopleHeadingId)}"><h3 id="${escapeHtml(peopleHeadingId)}">People</h3>${people?`<ul>${people}</ul>`:previewEmpty(content,'Published board and team members will appear here automatically.')}</section>${profile}</div>`;
    }
    function renderTeamHeroesPreview(block, items) {
        ...
        const profileHeadingId = `simple-team-heroes-profile-${block.uuid}`;
        const mapViewBox = String(teamPreviewMap.viewBox || '0 0 420 560');
        const map = showMap ? `<aside class="simple-preview-team-heroes__map" aria-label="Bangladesh map preview">${teamPreviewMapDivisions.length?`<div class="simple-preview-team-heroes__map-stage"><svg viewBox="${escapeHtml(mapViewBox)}" role="img" aria-label="Bangladesh division map preview"><title>Bangladesh division map preview</title>${teamPreviewMapDivisions.map(division=>`<g data-division="${escapeHtml(division.key)}"><title>${escapeHtml(teamPreviewMapDivisionName(division))}</title><path d="${escapeHtml(division.path)}" fill-rule="evenodd"></path></g>`).join('')}</svg></div>`:'<p class="simple-preview-team-heroes__empty">The shared Bangladesh map is unavailable in this preview.</p>'}</aside>` : '';
        const selectors = profiles.map((item,index)=>{const name=previewItemName(item)||'Team member';const image=previewItemImage(item);const initials=name.split(/\s+/).filter(Boolean).slice(0,2).map(part=>part[0]||'').join('').toUpperCase();const role=item.designation||item.position||item.title||'';return `<li class="simple-preview-team-heroes__person${index===0?' is-selected':''}" ${index===0?'aria-current="true"':''}><span class="simple-preview-team-heroes__avatar">${image?`<img src="${escapeHtml(image)}" alt="">`:`<span aria-hidden="true">${escapeHtml(initials||'IGF')}</span>`}</span><strong>${escapeHtml(name)}</strong>${role?`<small>${escapeHtml(role)}</small>`:''}</li>`}).join('');
        const name = featured ? previewItemName(featured) || 'Team member' : 'Featured profiles';
        ...
        const biographyParagraphs = biography.split(/\n\s*\n+/).map(plainText).filter(Boolean).slice(0,2);
        const qualification = featured ? plainText(featured.qualification || '') : '';
        const profile = featured ? `<article class="simple-preview-team-heroes__profile${animationEnabled?' is-animated':''}" role="region" aria-labelledby="${escapeHtml(profileHeadingId)}"><div class="simple-preview-team-heroes__profile-heading">${role?`<p class="simple-preview-team-heroes__role">${escapeHtml(role)}</p>`:''}<h3 id="${escapeHtml(profileHeadingId)}">${escapeHtml(name)}</h3><span class="simple-preview-team-heroes__socials" aria-label="Social links preview">${previewIcon('','fa-linkedin')}${previewIcon('','fa-globe')}</span></div><div class="simple-preview-team-heroes__biography">${biographyParagraphs.length?biographyParagraphs.map(paragraph=>`<p>${escapeHtml(paragraph)}</p>`).join(''):'<p>Biography and leadership story appear here when supplied in the team manager.</p><p>A second paragraph can add more context about this person’s work and experience.</p>'}</div>${qualification?`<p class="simple-preview-team-heroes__qualification"><strong>Background:</strong> ${escapeHtml(qualification)}</p>`:''}</article>` : `<p class="simple-preview-team-heroes__empty">${escapeHtml(content.empty_state || 'Published board and team members will appear here automatically.')}</p>`;
        ...
        const introduction = `<header class="simple-preview-team-heroes__heading"><p class="simple-preview-team-heroes__eyebrow"><span class="simple-preview-team-heroes__eyebrow-marks" aria-hidden="true"><span></span><span></span></span>${escapeHtml(content.eyebrow || 'Meet the Heroes')}</p><h2>${showcaseHeadingMarkup}</h2>${content.body?`<p class="simple-preview-team-heroes__lead">${escapeHtml(plainText(content.body))}</p>`:''}</header>`;
        const memberContent = `<div class="simple-preview-team-heroes__content">${introduction}${selectors?`<ul class="simple-preview-team-heroes__profiles" aria-label="Profile selector preview">${selectors}</ul>`:''}${profile}</div>`;
        return `<div class="simple-preview-team-heroes is-map-${mapPosition}${showMap?'':' simple-preview-team-heroes--no-map'}${animationEnabled?' is-motion-enabled':''}" data-autoplay="${autoplay}" role="region" aria-label="Meet the Heroes showcase preview">${memberContent}${map}</div>`;
    }
    ...
    function previewBlock(block) {
        ...
        if (block.type === 'team') {
            const items = managedPagePreviewItems(block);
            if (c.team_presentation === 'heroes_showcase') {
                return `<section ${previewSectionMeta(block,' simple-preview-block--team-heroes')}>${renderTeamHeroesPreview(block,items)}</section>`;
            }
            if (c.team_presentation === 'directory_map') {
                return `<section ${previewSectionMeta(block,' simple-preview-block--team-directory')}>${previewHeading(block)}${renderTeamDirectoryPreview(block,items)}</section>`;
            }
