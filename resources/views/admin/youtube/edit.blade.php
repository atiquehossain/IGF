                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <input name="id[{{$lang}}]" type="hidden" class="form-control" value="{{ @$youtube->id }}">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <input id="name" name="name[{{$lang}}]" type="text" value="{{old('name.'. $lang, @$youtube->name)}}" class="form-control" required data-e2e="youtube-name-{{ $lang }}">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <input id="video_id" name="video_id[{{$lang}}]" type="text" value="{{old('video_id.'. $lang, @$youtube->video_id)}}" class="form-control" required data-e2e="youtube-video-id-{{ $lang }}">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group has-success">
                                            ...
                                            <input id="activision_time" name="activision_time[{{$lang}}]" type="number" value="{{old('activision_time.'. $lang, @$youtube->activision_time)}}" class="form-control" data-e2e="youtube-activision-time-{{ $lang }}">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group has-success">
                                            ...
                                            <input id="duration_time" name="duration_time[{{$lang}}]" type="number" value="{{old('duration_time.'. $lang, @$youtube->duration_time)}}" class="form-control" data-e2e="youtube-duration-time-{{ $lang }}">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group has-success">
                                            ...
                                            <input id="activision_time" name="order_by[{{$lang}}]" type="number" value="{{old('order_by.'. $lang, @$youtube->order_by)}}" class="form-control" data-e2e="youtube-order-by-{{ $lang }}">
